export const data = [
  {
    ...
    education: [
      {
        degree:
          "Digital Systems and Robotics Bachelor's Degree (Overall average: 92)",
    ...
    experience: [
      ...
      {
        title: "Coworker in Medellín, Colombia",
        company: "Regnum Christi",
        date: "August 2014 - July 2015",
        description: [
          {
            line:
              "Spiritual guidance for female teenagers."
          },
          {
            line: "ECYD Coordinator responsible of weekly catechism."
          },
          {
